"""Agent persona definitions + persistence tests (.hdp/agents.json)."""
...
class TestAgents(unittest.TestCase):
    ...
    def test_load_missing_file_seeds_defaults(self):
        ...
        self.assertFalse((self.root / ".hdp" / "agents.json").exists())
