"""Project-structure awareness: a regenerable `.kaal/STRUCTURE.md` cache.

Scans the project tree once, writes a markdown tree into `.kaal/STRUCTURE.md`
...
class StructureManager:
    """Scan + cache a project's tree under ``.kaal/STRUCTURE.md``."""
    ...
    def cache_path(self) -> Path:
        return self.root / ".kaal" / "STRUCTURE.md"
