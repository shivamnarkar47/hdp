...
def get_store_dir() -> Path:
    """Session store directory: $KAAL_SESSIONS_DIR or the default XDG-ish path."""
    override = os.environ.get("KAAL_SESSIONS_DIR")
    if override:
        return Path(override)
    return Path.home() / ".local" / "share" / "kaal" / "sessions"
